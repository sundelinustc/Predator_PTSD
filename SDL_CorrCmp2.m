function [z p] = SDL_CorrCmp2(r1,r2,n1,n2)

% Adapted from Matlab function compare_correlation_coefficients.m by Sisi Ma

% This function compare if two correlation coefficients (of two groups) are significantly
% different.
...
% r1=corr(x,y1);
% r1=corr(x,y2);
% [z p] = SDL_CorrCmp2(r1,r2,length(x),length(x));
